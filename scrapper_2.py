...
browser = webdriver.Chrome("C:/Users/NEW/Downloads/web-scrapping-2-master/web-scrapping-2-master/chromedriver.exe")
browser.get(START_URL)
time.sleep(10)

headers = ["constellation", "right_ascension", "declination", "distance", "spectral_type", "mass", "radius"]
planet_data = []
new_planet_data = []
